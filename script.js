...
(function () {
  ...
  /* =========================================================
     Doctor auto-assignment map (Service -> Doctor)
     Note: "Scaling and Polishing" is listed under both Dr. Hanif Niazi
     and Dr. Tehseen Khatoon's service lists. To keep the booking dropdown
     unambiguous, it routes to Dr. Hanif Niazi (both doctors can still
     perform it in person; the clinic can redirect on arrival if needed).
     ========================================================= */
  var DOCTOR_MAP = {
    'Consultation': 'Dr. Hanif Niazi',
    'Tooth Extraction': 'Dr. Hanif Niazi',
    'Scaling and Polishing': 'Dr. Hanif Niazi',
    ...
    'Extractions': 'Dr. Tehseen Khatoon',
    'Fillings': 'Dr. Tehseen Khatoon',
    'Crowns & Bridges': 'Dr. Tehseen Khatoon',
    'Partial Dentures': 'Dr. Tehseen Khatoon',
    'Complete Dentures': 'Dr. Tehseen Khatoon'
  };
  ...
  if (form) {
    ...
    function updateAssignedDoctor() {
      ...
      var doctor = DOCTOR_MAP[service];
      if (doctor && assignedBox) {
        assignedBox.hidden = false;
        assignedBox.innerHTML = 'This appointment will be assigned to <strong>' + doctor + '</strong>.';
      } else if (assignedBox) {
        assignedBox.hidden = true;
      }
    }
    ...
    form.addEventListener('submit', function (e) {
      ...
      var doctor = DOCTOR_MAP[data.service] || 'Our team';
